...
preflight() {
  ...
  v10=$(grep -c 'trace-v10-feed-publish' workflow/facebook-us-news-automation.json 2>/dev/null || echo 0)
  echo "Workflow: trace-v10=$v10 pipelineLog-fn=$markers (want v10>=1, fn=0)"
  if [ "${v10:-0}" -lt 1 ]; then
